...
namespace WebApplication1.Controllers
{
    ...
    {
        private Class1Context db = new Class1Context();
        ...
        public ActionResult Create([Bind(Include = "EmpId,Name,Salary")] Class1 class1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,Name,Salary")] Class1 class1)
        {
            if (ModelState.IsValid)
            {
